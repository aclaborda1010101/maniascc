...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  sugerido: { label: "Sugerido", className: "bg-accent/10 text-accent border-accent/20" },
  contactado: { label: "Contactado", className: "bg-chart-1/10 text-chart-1 border-chart-1/20" },
  aprobado: { label: "Aprobado", className: "bg-chart-2/10 text-chart-2 border-chart-2/20" },
  exito: { label: "Éxito", className: "bg-chart-2/10 text-chart-2 border-chart-2/20" },
